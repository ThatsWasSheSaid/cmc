...
<head>
    ...
    <!-- normalize.css -->
    <link rel="stylesheet" type="text/css" media="screen" href="_css/editaFerragem.css" />
    <!-- main.css -->
    ...
    <!-- editaPisos -->
    <script src="_js/editaFerragem.js"></script>
</head>
<body>
...
<?php require_once('pages/navbar.php')?>
    <div class="wrapper">
        <div class="tool-bar">
            ...
            <a href="editaFerragem.php?idprojeto=<?php echo $idProjeto?>"><div class="icone tipo-active"">
                <img style="margin-top:18px" src="_assets/img/ferragem-laranja.png">
            </div></a>
        ...
        <div class="edit-Item" id="edit-Item">
            ...
            <form action="" method="post" id="form-item">
                ...
                <div class="linha">
                    <label for="massa">Quantidade de Barras por viga/coluna</label>
                    <input type="decimal" name="qtdeBarras" id="qtdeBarras" value="">Barras
                </div>

                <div class="linha">
                    <label for="altParede">Comprimento da viga/coluna</label>
                    <input type="decimal" name="comprimentoCol" id="comprimentoCol" value="">Metros
                </div>
            ...
            <div class="resultado">
                <p>Total: <span id="totalMaterial"></span> Barras</p>
    ...
    <div class="addMaterial" id="addMaterial">
        <div class="addMaterial-form">
            <form id="form-addMaterial">
                ...
                <input type="text" name="nomeMaterial" id="nomeMaterial" placeholder="Nome do Ferragem">
